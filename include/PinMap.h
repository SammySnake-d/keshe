...
// ==========================================
// OV2640 XCLK 配置说明:
//   - 参考 project-name/main/camera_module.h: CAM_PIN_XCLK = -1
//   - 假设使用外部 20MHz 晶振，无需 ESP32 生成时钟
//   - 如果没有外部晶振，需要飞线 GPIO2 到 OV2640 XCLK 并将此值改为 2
#define PIN_CAM_XCLK -1  // 外部晶振 (参考 project-name)
